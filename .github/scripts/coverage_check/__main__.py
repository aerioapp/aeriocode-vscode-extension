...
from .extraction import compare_coverage, extract_coverage, run_coverage, set_verbose
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Coverage utility script for GitHub Actions workflows",
    ...
    compare_parser = subparsers.add_parser(
        "compare-coverage", help="Compare coverage percentages", parents=[parent_parser]
    )
    ...
    comment_parser = subparsers.add_parser(
        "generate-comment",
        help="Generate PR comment with coverage comparison",
        parents=[parent_parser],
    )
    ...
    run_parser = subparsers.add_parser(
        "run-coverage",
        help="Run a coverage command and extract the coverage percentage",
        parents=[parent_parser],
    )
    ...
    workflow_parser = subparsers.add_parser(
        "process-workflow",
        help="Process the entire coverage workflow",
        parents=[parent_parser],
    )
    ...
    output_parser = subparsers.add_parser(
        "set-github-output",
        help="Set GitHub Actions output variable",
        parents=[parent_parser],
    )
