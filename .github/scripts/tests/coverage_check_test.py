...
from coverage_check.util import file_exists, get_file_size, log  # noqa: E402
...
class TestCoverage(unittest.TestCase):
    ...
    def test_extract_coverage(self):
        ...
        self.assertTrue(
            file_exists(self.extension_coverage_file),
            f"Extension coverage file does not exist: {self.extension_coverage_file}",
        )
        self.assertTrue(
            file_exists(self.webview_coverage_file),
    ...
    def test_generate_comment(self):
        ...
        comment = generate_comment(80, 90, "false", 10, 70, 75, "false", 5)
    ...
    def test_set_github_output(self):
        ...
        with patch("sys.stdout", new=MagicMock()) as mock_stdout:
            ...
            with patch.dict("os.environ", {"GITHUB_OUTPUT": "/tmp/github_output"}), patch(
