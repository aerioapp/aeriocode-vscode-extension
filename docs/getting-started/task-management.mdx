---
title: "Task Management in Aeriocode"
description: "Learn how to effectively manage your task history, use favorites, and organize your work in Aeriocode."
---

# Task Management

As you use Aeriocode, you'll accumulate many tasks over time. The task management system helps you organize, filter, search, and clean up your task history to keep your workspace efficient.

## Accessing Task History

You can access your task history by:

1. Clicking on the "History" button in the Aeriocode sidebar
2. Using the command palette to search for "Aeriocode: Show Task History"
...
-   **Open**: Click on a task to reopen it in the Aeriocode chat
...
Task management helps you maintain an organized workflow when using Aeriocode, allowing you to quickly find past conversations, preserve important work, and keep your history clean and efficient.
