...
// Set up CLI metadata
program.name("aeriocode-eval").description("CLI tool for orchestrating Aeriocode evaluations across multiple benchmarks").version("0.1.0")
...
program
	...
	.option("-k, --api-key <apiKey>", "Aeriocode API key to use for evaluations")
	.action(async (options) => {
		try {
