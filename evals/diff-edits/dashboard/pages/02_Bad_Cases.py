...
from utils import (  # Absolute import
    get_database_connection,
    guess_language_from_filepath,
)

st.set_page_config(page_title="Case Health Inspector", page_icon="🧑‍⚕️", layout="wide")
...
def render_problematic_cases_page():
    ...
    st.dataframe(
        summary_df.style.format({"percent_valid_attempts": "{:.1f}%", "success_rate_on_valid": "{:.1f}%"}),
