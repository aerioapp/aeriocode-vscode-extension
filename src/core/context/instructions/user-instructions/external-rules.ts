...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: AeriocodeRulesToggles
	cursorLocalToggles: AeriocodeRulesToggles
}> {
	// local windsurf toggles
	const localWindsurfRulesToggles =
		((await getWorkspaceState(context, "localWindsurfRulesToggles")) as AeriocodeRulesToggles) || {}
	...
	const localCursorRulesToggles = ((await getWorkspaceState(context, "localCursorRulesToggles")) as AeriocodeRulesToggles) || {}
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: AeriocodeRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: AeriocodeRulesToggles) => {
