...
import { convertApiConfigurationFromProto } from "@shared/proto-conversions/models/api-configuration-conversion"
...
export async function updateApiConfigurationProto(
	...
	try {
		...
		const appApiConfiguration = convertApiConfigurationFromProto(request.apiConfiguration)
