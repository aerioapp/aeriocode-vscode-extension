...
// MCP tool identifier for matching MCP tools
const MCP_TOOL_IDENTIFIER = "__" // MCP tools typically have __ in their name
...
export class ToolExecutorCoordinator {
	...
	getHandler(toolName: string): IToolHandler | undefined {
		// Normalize MCP tool names to the standard handler
		if (toolName.includes(MCP_TOOL_IDENTIFIER)) {
