 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Aeriocode's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Aeriocode Checkpoint")
		await git.addConfig("user.email", "checkpoint@aeriocode.bot")
