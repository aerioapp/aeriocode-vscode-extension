...
async function performCommitGeneration(context: vscode.ExtensionContext, gitDiff: string, inputBox: any) {
	try {
		vscode.commands.executeCommand("setContext", "aeriocode.isGeneratingCommit", true)
...
Commit message:`
		...
		vscode.commands.executeCommand("setContext", "aeriocode.isGeneratingCommit", false)
	}
}
