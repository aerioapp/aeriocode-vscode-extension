...
export async function regexSearchFiles(
	...
	// Filter results using AeriocodeIgnoreController if provided
	const filteredResults = aeriocodeIgnoreController
		? results.filter((result) => aeriocodeIgnoreController.validateAccess(result.filePath))
		: results
