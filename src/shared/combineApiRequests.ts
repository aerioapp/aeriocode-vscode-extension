...
/**
 * Combines API request start and finish messages in an array of AeriocodeMessages.
 *
 ...
 * @returns A new array of AeriocodeMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: AeriocodeMessage[]): AeriocodeMessage[] {
	const combinedApiRequests: AeriocodeMessage[] = []
