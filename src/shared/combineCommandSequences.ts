import { AeriocodeMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of AeriocodeMessages.
 *
 * This function processes an array of AeriocodeMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of AeriocodeMessage objects to process.
 * @returns A new array of AeriocodeMessage objects with command sequences combined.
 *
 * @example
 * const messages: AeriocodeMessage[] = [
 ...
 */
export function combineCommandSequences(messages: AeriocodeMessage[]): AeriocodeMessage[] {
	const combinedCommands: AeriocodeMessage[] = []
