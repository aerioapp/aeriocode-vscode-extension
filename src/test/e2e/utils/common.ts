...
export const addSelectedCodeToAeriocodeWebview = async (_page: Page) => {
	...
	await _page.keyboard.press("Enter", { delay: 100 }) // First action - "Add to Aeriocode"
}

export const getAeriocodeEditorWebviewFrame = async (_page: Page) => {
