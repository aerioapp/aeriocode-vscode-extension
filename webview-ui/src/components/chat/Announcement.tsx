		...
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				...
				<li>
					...
					them get started with Aeriocode more easily.
				</li>
				<li>
			...
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						<li>
							<b>Optimized for Claude 4:</b> Aeriocode is now optimized to work with the Claude 4 family of models,
						...
						<li>
							<b>WebFetch Tool:</b> Gemini 2.5 Pro and Claude 4 models now support the WebFetch tool, allowing
							Aeriocode to retrieve and summarize web content directly in conversations.
						</li>
						<li>
							<b>Self Knowledge:</b> When using frontier models, Aeriocode is self-aware about his capabilities and
							featureset.
						</li>
						<li>
