...
interface MessageRendererProps {
	index: number
	messageOrGroup: AeriocodeMessage | AeriocodeMessage[]
	groupedMessages: (AeriocodeMessage | AeriocodeMessage[])[]
...
export const createMessageRenderer = (
	...
	return (index: number, messageOrGroup: AeriocodeMessage | AeriocodeMessage[]) => (
		<MessageRenderer
			index={index}
