...
export const useIsStreaming = (
	...
	return useMemo(() => {
		...
		const isToolCurrentlyAsking = isLastAsk && aeriocodeAsk !== undefined && enableButtons && primaryButtonText !== undefined
		...
		return false
	}, [modifiedMessages, aeriocodeAsk, enableButtons, primaryButtonText])
}
