...
import { AeriocodeMessage, AeriocodeSayTool } from "@shared/ExtensionMessage"
 ...
 */
export function useButtonState(messages: AeriocodeMessage[], chatState: ChatState) {
	const {
		setSendingDisabled,
		setEnableButtons,
				...
				case "ask":
					...
					switch (lastMessage.ask) {
						...
						case "tool":
							...
							const tool = JSON.parse(lastMessage.text || "{}") as AeriocodeSayTool
							switch (tool.tool) {
