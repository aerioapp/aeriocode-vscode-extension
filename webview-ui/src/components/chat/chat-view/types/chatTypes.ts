...
export interface ChatState {
	...
	// Derived values
	lastMessage: AeriocodeMessage | undefined
	secondLastMessage: AeriocodeMessage | undefined
	aeriocodeAsk: AeriocodeAsk | undefined
	task: AeriocodeMessage | undefined
...
export interface TaskSectionProps {
	...
	isStreaming: boolean
	aeriocodeAsk?: AeriocodeAsk
	modifiedMessages: AeriocodeMessage[]
}
