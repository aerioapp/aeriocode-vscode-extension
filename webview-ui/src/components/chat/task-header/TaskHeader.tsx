...
import { StringArrayRequest, StringRequest } from "@shared/proto/aeriocode/common"
...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	const { apiConfiguration, currentTaskItem, checkpointTrackerErrorMessage, aeriocodeMessages, navigateToSettings, mode } =
		useExtensionState()
	...
	*/
	...
	const isCostAvailable = useMemo(() => {
		// Since we're only supporting Aeriocode, cost is always available
		return true
									...
									<span>
										...
										{checkpointTrackerErrorMessage.includes("Git must be installed to use checkpoints.") && (
											<>
												{" "}
												<a
													href="https://github.com/aerioapp/aeriocode-vscode-extension/wiki/Installing-Git-for-Checkpoints"
													style={{
														color: "inherit",
