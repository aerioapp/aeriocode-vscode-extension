...
import { TelemetrySettingEnum, TelemetrySettingRequest } from "@shared/proto/aeriocode/state"
...
const TelemetryBanner = () => {
	...
	return (
		<BannerContainer>
			...
			<div>
				<strong>Help Improve Aeriocode</strong>
				<i>
					<br />
					(and access experimental features)
				</i>
				<div style={{ marginTop: 4 }}>
					Aeriocode collects error and usage data to help us fix bugs and improve the extension. No code, prompts, or
