...
import { Int64, Int64Request, StringRequest } from "@shared/proto/aeriocode/common"
import Section from "../Section"
import { updateSetting } from "../utils/settingsHandlers"
import { UpdateTerminalConnectionTimeoutResponse } from "@shared/proto/index.aeriocode"
				...
				<div id="terminal-settings-section" className="mb-5">
					<div className="mb-4">
						...
						<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
							Select the default terminal Aeriocode will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
					...
					<div className="mb-4">
						...
						<p className="text-xs text-[var(--vscode-descriptionForeground)]">
							Set how long Aeriocode waits for shell integration to activate before executing commands. Increase
					...
					<div className="mb-4">
						...
						<p className="text-xs text-[var(--vscode-descriptionForeground)]">
							When enabled, Aeriocode will reuse existing terminal windows that aren't in the current working
